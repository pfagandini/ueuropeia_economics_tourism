...
ggplot() +
  ...
  annotate("text", x = 4.2, y = 2.2, label = "Accommodate\n(share market)", fontface = "bold",
...
ggplot() +
  ...
  annotate("text", x = 0, y = 5.6, label = "Entrant", fontface = "bold",
           size = 5, color = ue_black) +
  annotate("text", x = 3, y = 3.6, label = "Incumbent\n(with excess capacity)",
  ...
  annotate("text", x = 1.8, y = 2.2, label = "Fight", fontface = "bold",
           size = 4, color = ue_red) +
  annotate("text", x = 4.2, y = 2.2, label = "Accommodate", fontface = "bold",
  ...
  annotate("text", x = 3.8, y = 1.6, label = "100 > 50 ✓",
           size = 3.5, color = ue_red, fontface = "bold") +
  annotate("text", x = -1.8, y = 3.5, label = "0 > -100 ✓",
