...
::: {.key-concept}
A **Central Bank** is the institution responsible for managing a country's (or currency area's) **money supply and interest rates**. It acts as the "bank of banks" and the ultimate guardian of monetary stability.
:::
...
## Central Bank Independence :classical_building:
...
## The Key Tool: Interest Rates :control_knobs:
...
## Monetary Policy and Tourism — Putting it Together :beach_umbrella:
...
**(a)** Classify this ECB action as expansionary or contractionary monetary policy, and explain why this classification applies. *(2 marks)*

**(b)** Describe the **transmission mechanism** through which this rate increase was intended to reduce inflation. Identify at least three steps in the chain. *(4 marks)*

**(c)** A hotel group in Lisbon had taken on €20 million in variable-rate debt to finance a new property, at an interest rate of Euribor + 1%. When Euribor was -0.3%, the annual interest bill was approximately €140,000. After the rate hike cycle, Euribor reached 3.9%. Calculate the new annual interest bill and comment on the implications for the hotel group's investment decisions. *(4 marks)*
