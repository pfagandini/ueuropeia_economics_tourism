...
## The Definition :classical_building: {.smaller}
...
## Fiscal Policy vs Monetary Policy :balance_scale: {.smaller}
...
## Expansionary Fiscal Policy :chart_with_upwards_trend: {.smaller}
...
## Contractionary Fiscal Policy :chart_with_downwards_trend: {.smaller}
...
## Built-in Fiscal Cushions {.smaller}
...
## Tourist Taxes — Fiscal Policy in Action :beach_umbrella: {.smaller}
...
## Tourism Subsidies — Expansionary Fiscal Policy :airplane: {.smaller}
...
**(a)** Explain, using the concepts of aggregate demand and the multiplier, how this contractionary fiscal policy was expected to affect the economy.

**(b)** Identify **two specific channels** through which these austerity measures would affect Portugal's tourism sector. 

**(c)** Despite the pain of austerity, Portugal successfully exited its bailout programme in 2014 and achieved a budget surplus by 2019. Explain the fiscal policy classification of this surplus and what it implies for the government's fiscal space. 
