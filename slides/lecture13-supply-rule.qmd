...
p_move <- ggplot() +
  geom_segment(aes(x = 0, y = 2, xend = 10, yend = 8),
  ...
  geom_segment(aes(x = 0, y = 7, xend = 6.25, yend = 7),
               linetype = "dashed", color = ue_gray) +
  annotate("segment", x = 4.5, y = 5.5, xend = 5.5, yend = 6.5,
           arrow = arrow(length = unit(0.2, "cm")), color = ue_red, linewidth = 1) +
  annotate("text", x = 9, y = 7.5, label = "S", color = ue_red,
...
p_shift <- ggplot() +
  ...
  geom_segment(aes(x = 0, y = 2, xend = 8, yend = 8),
               color = ue_red, linewidth = 1.5) +
  annotate("text", x = 9.5, y = 7.5, label = expression(S[1]), color = ue_gray,
           fontface = "bold.italic", size = 5) +
  annotate("text", x = 7.5, y = 7.5, label = expression(S[2]), color = ue_red,
           fontface = "bold.italic", size = 5) +
  annotate("segment", x = 7, y = 5, xend = 5, yend = 5,
